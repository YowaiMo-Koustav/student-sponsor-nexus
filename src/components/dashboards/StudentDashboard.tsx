...
import RecommendedSponsors from '@/components/analytics/RecommendedSponsors';
import EventPerformanceChart from '@/components/analytics/EventPerformanceChart';
import SponsorResponseRateChart from '@/components/analytics/SponsorResponseRateChart';
import TopSponsorCategoriesChart from '@/components/analytics/TopSponsorCategoriesChart';
import RevenueChart from '@/components/analytics/RevenueChart';
import EventCalendar from '@/components/analytics/EventCalendar';
import { 
  Plus, 
  Calendar, 
  Users, 
      ...
      <Tabs defaultValue="overview" className="mt-8">
        ...
        <TabsContent value="analytics">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <SponsorResponseRateChart />
            </div>
            <div className="mt-8">
                <TopSponsorCategoriesChart />
            </div>
            <div className="mt-8">
                <RevenueChart />
            </div>
        ...
        <TabsContent value="recommendations">
            {events.length > 0 && (
                <RecommendedSponsors eventId={events[0].id} />
            )}
        </TabsContent>
      </Tabs>
